...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public SetupDataLoader(AdminRoleService adminRoleService, PermissionService permissionService, UserRepository adminUserRepository, PasswordEncoder passwordEncoder) {
